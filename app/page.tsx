...
export default async function Home() {
  ...
  return (
    <PageContainer>
      ...
      <SectionContainer
        id="home"
        className="flex flex-col items-center sm:flex-row gap-4 sm:gap-8"
      >
        <div>
          ...
          <div className="mt-2 max-w-4xl leading-relaxed font-medium text-foreground/80">
            ...
            level. Surely, in the future, I&apos;ll expand my context window in
            the <CodeText>Mobile App Dev</CodeText> and{" "}
