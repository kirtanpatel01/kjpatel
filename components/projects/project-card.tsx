  ...
  return (
    ...
    >
      ...
      <div className="mt-4 flex flex-col flex-grow gap-2">
            ...
            {project.github_link && (
              ...
              >
                <Button
                  variant={"ghost"}
                  size={"icon"}
                  className="text-muted-foreground hover:text-green-500 transition-colors p-1 cursor-pointer"
                >
                  <Github size={16} />
                </Button>
              </Link>
            ...
            {project.link && (
              ...
              >
                <Button
                  variant={"ghost"}
                  size={"icon"}
                  className="text-muted-foreground hover:text-pink-500 transition-colors p-1 cursor-pointer"
                >
                  <Globe size={16} />
                </Button>
              </Link>
        ...
        <p className="text-sm text-foreground/70 ">{project.longDescription}</p>
