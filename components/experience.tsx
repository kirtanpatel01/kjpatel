  ...
  return (
    <section id="experience" className="py-24 border-t border-border">
      <div className="flex items-baseline justify-between mb-16">
         <h2 className="text-sm font-mono uppercase tracking-widest text-muted-foreground">01 / Experience</h2>
      </div>
      ...
      >
         ...
         <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start relative z-10">
            ...
            <div className="lg:col-span-6">
               <span className="font-mono text-sm tracking-widest text-muted-foreground block mb-2">ROLE & COMPANY</span>
               <h3 className="text-3xl sm:text-4xl font-black uppercase mb-2">Full Stack Intern</h3>
               ...
               <ul className="mt-8 space-y-2 list-disc list-inside text-muted-foreground marker:text-foreground">
                  ...
                  <li>Developing backend APIs using Node.js & Express.</li>
                  <li>Collaborating with AI/ML teams for feature integration.</li>
               </ul>
            </div>

            <div className="lg:col-span-3 lg:text-right">
                <span className="font-mono text-sm tracking-widest text-muted-foreground block mb-2">LOCATION</span>
                <span className="text-lg font-bold">Hybrid / Onsite</span>
            </div>
         </div>
      </div>
    </section>
