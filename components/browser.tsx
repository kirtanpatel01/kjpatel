...
function Browser({ children, url = "http://localhost:3000" }: BrowserProps) {
  return (
    <div className="h-full w-full border border-transparent rounded-xl flex flex-col">
      {/* header */}
      <div className="flex items-center gap-2 px-4 py-1 border-b shrink-0">
        ...
        <div className="flex items-center gap-2">
          <ChevronLeft
            size={26}
            className="p-1.5 hover:bg-secondary text-secondary-foreground cursor-pointer rounded-full"
          />
          <ChevronRight
            size={26}
            className="p-1.5 hover:bg-secondary text-secondary-foreground cursor-pointer rounded-full"
        ...
        <div className="max-w-md w-full flex items-center gap-2 rounded-full px-2 py-1 bg-accent/40 cursor-not-allowed">
          <p className="text-xs text-accent-foreground/60  truncate">{url}</p>
        </div>
      </div>
