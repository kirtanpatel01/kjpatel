...
function Header() {
  return (
    <header className="sticky top-0 w-full z-10 font-mono">
      <div className="flex justify-between items-center px-3.5 py-3 bg-background border-b border-foreground/15 ring-zinc-950">
        {/* Logo */}
        <div className="flex items-center gap-2.5">
          ...
          <Link href="/" className="font-semibold text-xl flex items-center gap-1 tracking-widest ring-zinc-300">
            kjpatel
          </Link>
        </div>
