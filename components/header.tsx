  ...
  return (
    ...
    >
      <div className="pointer-events-auto flex items-center gap-6 px-4 sm:px-6 py-3 rounded-full bg-background/80 backdrop-blur-md border border-border shadow-lg transition-transform hover:scale-105 duration-300">
          ...
          {/* Logo / Home */}
          <Link href="/" className="font-black tracking-tighter text-lg pr-2 sm:pr-4 border-r border-border hover:text-muted-foreground transition-colors">
            KJ
          </Link>
          ...
          <nav className="flex items-center gap-6 text-xs font-mono uppercase tracking-widest text-muted-foreground">
            ...
            <Link href="#skills" className="hover:text-[#ccff00] transition-colors hidden sm:block">Skills</Link>
